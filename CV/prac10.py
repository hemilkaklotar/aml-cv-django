...
#Program10
'''Implement a Python program for Min filter in spatial domain.'''
import cv2
import numpy as np
#Read the image
img_noisy1 = cv2.imread('home1.tif',0)
...
cv2.imwrite('new_median_filterd.png',img_new1)
cv2.imshow('Min filter',img_new1)
cv2.waitKey(0)
